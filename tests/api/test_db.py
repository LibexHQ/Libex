...
async def test_search_db_narrators_returns_200(async_client):
    ...
    with patch("app.api.routes.db.router.search_narrators_from_db", new_callable=AsyncMock) as mock:
        mock.return_value = [{"name": "Jim Dale", "description": None, "image": None, "website": None, "wikipediaUrl": None, "languages": None, "accents": None, "gender": None, "genresNarrated": None, "audiobooksProduced": None, "culturalHeritage": None, "publishers": None, "socialLinks": None, "source": None, "sourceUrl": None, "sourceUpdatedAt": None, "attribution": None, "updatedAt": None}]
