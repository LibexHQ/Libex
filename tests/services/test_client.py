...
# ============================================================
# RETRY / BACKOFF HELPERS -- pure functions, unaffected by LibexClient's
# move to a per-instance transport. Retry/backoff behaviour exercised
# through LibexClient.get itself lives in tests/libex_core/test_transport.py.
# ============================================================
